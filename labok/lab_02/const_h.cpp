...
// 1.
    const int i;
    ///Létrehoztuk a változót, konstansként, de értéket nem adtunk neki, így később sem lehet neki értéket adni.
// 2.
    const int j = 10;
    j++;
    ///A változó konstans, nem lehet növelni.
